<?php
    ...
    /**
     * Class Manager is responsible for handling errors, exceptions, and providing a detailed
     * backtrace mechanism, alongside default error handling initialization and processing.
     */
    class Manager
    {
